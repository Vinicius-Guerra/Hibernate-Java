...
public class ProdutoDao {
    ...
    public List<Produto> budcarPorParametros(String nome, BigDecimal preco, LocalDate dataCadastro) {
    ...
    public List<Produto> budcarPorParametrosComCriteria(String nome, BigDecimal preco, LocalDate dataCadastro){
